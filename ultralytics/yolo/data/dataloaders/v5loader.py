...
class LoadScreenshots:
    # YOLOv5 screenshot dataloader, i.e. `python download_all_models.py --source "screen 0 100 100 512 256"`
...
class LoadImages:
    # YOLOv5 image/video dataloader, i.e. `python download_all_models.py --source image.jpg/vid.mp4`
...
class LoadStreams:
    # YOLOv5 streamloader, i.e. `python download_all_models.py --source 'rtsp://example.com/media.mp4'  # RTSP, RTMP, HTTP streams`
